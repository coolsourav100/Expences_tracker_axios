...
form.addEventListener('submit',(e)=>{
  ...
  axios.post("https://crudcrud.com/api/a1c071745ad746fda75409d03f1be474/data",{obj})
  .then((res)=>{
    showOndisplay()
...
async function showOndisplay(){
  ...
  let localdata = await axios.get("https://crudcrud.com/api/a1c071745ad746fda75409d03f1be474/data")
  .then((res)=>{
...
localdata.map((ele)=>{
  ...
  li.textContent = `Name : ${ele.obj.name}  Expences Amount : ${ele.obj.amount}  Descriptation :${ele.obj.des} Catagory : ${ele.obj.cat}`
  ...
  deletebutton.addEventListener('click',async ()=>{
    // console.log(ele._id)
     await axios.delete(`https://crudcrud.com/api/a1c071745ad746fda75409d03f1be474/data/${ele._id}`)
      list.removeChild(li)
      // location.reload()
      let name1 = document.getElementById('name')
  let amount1 = document.getElementById('amount')
